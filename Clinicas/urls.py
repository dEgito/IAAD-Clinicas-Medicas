...
urlpatterns = [
    ...
    path("edit_clinica_medico/<int:id>/", edit_clinica_medico, name='edit_clinica_medico'),
    path("update_clinica_medico/<int:id>/", update_clinica_medico, name='update_clinica_medico'),
